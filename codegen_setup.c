...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Syphon Filter 3",
    .project_root_env = "SYPHON_FILTER_3_RECOMP_PROJECT_ROOT",
    .build_dir_env = "SYPHON_FILTER_3_RECOMP_BUILD_DIR",
    .force_setup_env = "SYPHON_FILTER_3_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_946.40_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Syphon_Filter_3__Recompiled",
    .prepare_note =
