...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/syphon-filter-3-recomp/total)](https://github.com/Alexbeav/syphon-filter-3-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/syphon-filter-3-recomp/latest/total)](https://github.com/Alexbeav/syphon-filter-3-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/syphon-filter-3-recomp)](https://github.com/Alexbeav/syphon-filter-3-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Syphon Filter 3** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

Syphon Filter 3 recompiled for modern systems using psxrecomp.
...
Zip prefix for CI artifacts: `syphon-filter-3-recomp`.
