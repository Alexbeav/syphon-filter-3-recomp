# Syphon Filter 3 feasibility binding

## Identity

- Title and region: Syphon Filter 3, USA.
- Serial: SCUS-94640.
- Source executable path: `disc/SCUS_946.40`.
- Load address: `0x80010000`.
- Entry point: `0x800FB368`.
- Source disc binding: `disc/Syphon Filter 3 (USA).cue`.
...
The clean source commit is `466418ec98721e56f52d93aa243a8fcf0f119009`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 2284 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `466418ec98721e56f52d93aa243a8fcf0f119009`.
- Portfolio `syphon-filter-3/BUILDINFO.json`.
- Portfolio `syphon-filter-3/RECEIPT.md`.
